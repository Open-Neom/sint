...
class SintSnackBar extends StatefulWidget {
  ...
  /// of message you are displaying. Other ui may break the layout
  final Widget? icon;
  ...
  /// A [TextFormField] in case you want a engine user input.
  ...
  @override
  State createState() => SintSnackBarState();

  /// Show the snack. It's call [SnackbarStatus.OPENING] state
  /// followed by [SnackbarStatus.OPEN]
  SnackbarController show() {
    return Sint.showSnackbar(this);
  }
}

class SintSnackBarState extends State<SintSnackBar>
...
You need to either use message[String], or messageText[Widget] or define a userInputForm[Form] in GetSnackbar''');
  ...
  void _configureLeftBarFuture() {
    SintEngine.instance.addPostFrameCallback(
      (_) {
